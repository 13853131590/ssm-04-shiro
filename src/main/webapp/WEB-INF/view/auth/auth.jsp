    ...
    <script type="text/javascript">
        ...
        function initAuthTree() {
          $("#authTree").treegrid({
                  ...
                  collapsible: true,
                  fitColumns: true,
                  /*url: path+'/static/test/treegrid_data2.json',*/
...
<div id="authEditWin" style="width:100%;padding:10px 30px;" align="center">
