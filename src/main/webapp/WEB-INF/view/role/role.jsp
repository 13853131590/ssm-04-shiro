                ...
                toolbar:"#roletb",
                    columns:[[
                        ...
                        {field:'id',title:'操作',width:100,
                                formatter: function(value,row,index) {
                                return "<a href='javascript:void(0)' onclick='showGrantWin("+value+")'>授 权</a>"
                        }}
...
<table id="roleGrid">
    ...
    <div id="roleEditWin" style="width:100%;padding:10px 30px;" align="center">
    ...
    <div id="grantWin" style="width:100%;padding:10px 30px;" >
